...
export const houseSubmitValidator = joi.object({
    title: joi.string()
        .required()
        .min(3)
        .max(25)
...
export const houseEditValidator = joi.object({
    houseId: joi.string()
        .uuid()
        .message('شناسه ملک انتخابی برای ویرایش معتبر نیست!'),
    title: joi.string()
        .required()
        .min(3)
        .max(25)
...
export const validateID = joi.object({
    id: joi.string()
        .uuid()
        .message('شناسه ملک وارد شده معتبر نیست!'),
});
